    ...
    <section id='about' className='section'>
      <article>
        ...
        <p className='about-p'>
          ...
          I'm the youngest of three but the first to go in the academic route, currently navigating the world of Computer Science
          as a student at The Hebrew University of Jerusalem.
        </p>
        <p className='about-p'>
      ...
      <article>
        ...
        <ul className='about-recommendations-list'>
          ...
          <li>
            <em>Movies:</em> Bullet Train, American History X, Papillon<span className='about-recommendations-note'>(1973)</span>.
          </li>
          <li>
